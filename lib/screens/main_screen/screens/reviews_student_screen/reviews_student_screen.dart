...
class _ReviewsStudentScreenState extends State<ReviewsStudentScreen> {
                ...
                builder: (_, isLoadingValue, _) {
                    ...
                    return Skeletonizer(
                      ...
                      child: Column(
                        ...
                        children: reviewsList
                            .map((el) => _buildContainerReviews(el))
                            .toList(),
                      ),
                    );
                  }
                  return ValueListenableBuilder(
                    ...
                    builder: (context, reviewsStudentValue, child) {
                      return Column(
                        spacing: 20,
                        children: reviewsStudentValue.reversed.map((el) => _buildContainerReviews(el)).toList(),
                      );
                    }
                  );
                }
  ...
  Widget _buildContainerReviews(ReviewsStudent el) {
    return Container(
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(
