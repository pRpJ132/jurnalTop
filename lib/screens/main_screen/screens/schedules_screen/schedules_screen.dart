...
import 'package:my_app/services/db/schedule_history_db.dart';
...
class _SchedulesScreenState extends State<SchedulesScreen> {
  ...
  final _schedules = ValueNotifier<List<DayLessons>>([]);
  ScheduleHistoryDatabase dbScheduleHistory = ScheduleHistoryDatabase();
  ...
  Future<void> _loadSchedules() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<DayLessons> dt = data.map((e) => DayLessons.fromJson(e)).toList();
  ...
  void _showDayDialog(DateTime? day) {
    ...
    List<DayLessons> dayLessons = _schedules.value.where(
      (e) => e.date == dateStr
    ).toList();
